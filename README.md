# FTracker v1.8.05 — Dynamic Index refinement + UI consistency
...
- Application, manifest and service-worker versions synchronized to 1.8.05.
...
v1.8.05: Индекс динамики — выровнен заголовок «Параметры тела», счётчик вынесен в отдельную компактную строку, описание цели разделено на заголовок и пояснение; легенда направлений приведена к компактному двухстрочному виду. Расчётная логика не изменена.
