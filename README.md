# FTracker v1.8.52 — Historical Working Weight & Workout Progress
...
- Версия приложения, manifest, Service Worker, cache name, query-version и дата релиза синхронизированы: **v1.8.52 от 22.09.26**.
