# FTracker v1.8.04 — Dynamic Index refinement + UI consistency
...
- Application, manifest and service-worker versions synchronized to 1.8.04.
...
v1.8.04: Индекс динамики — выровнен заголовок «Параметры тела», счётчик вынесен в отдельную компактную строку, описание цели разделено на заголовок и пояснение; легенда направлений приведена к компактному двухстрочному виду. Расчётная логика не изменена.
